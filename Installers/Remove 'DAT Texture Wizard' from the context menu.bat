...
del "%sendToFolder%\DAT Texture Wizard.lnk"

del "%sendToFolder%\OverwriterRedirection.bat" /ah

if not exist "%sendToFolder%\DAT Texture Wizard.lnk" goto :ShortcutDeleted
